...
```
cd existing_repo
git remote add origin https://gitlab.com/thetoweruk-group/directdebit.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/thetoweruk-group/directdebit/-/settings/integrations)
